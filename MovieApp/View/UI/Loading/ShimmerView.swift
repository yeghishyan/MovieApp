...
//  ShimmerView.swift
//
// https://github.com/iosmasterydev/shimmer-effect/
//
...
public struct Shimmer: ViewModifier {
    ...
    struct GradientMask: View {
        let phase: CGFloat
        let centerColor = Color.steam_background.opacity(0.45)
        let edgeColor = Color.steam_foreground.opacity(0.25)
...
public extension View {
    ...
    @ViewBuilder func shimmering(
        active: Bool = true, duration: Double = 2.0, bounce: Bool = false
    ) -> some View {
        if active {
