...
class ImageLoader: ObservableObject {
    ...
    init(path: String?, size: Size = Size.sd) {
        self.imagePath = path
        loadImage(size: size)
    }
...
//
//    public init(path: String?, size: ImageService.Size = ImageService.Size.sd) {
//        self.size = size
//        self.path = path
//
...
//            return
//        }
//        cancellable = ImageService.shared.fetchImage(imagePath: imagePath, size: size)
